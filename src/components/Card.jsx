const Card = ({ title, firstName, lastName, family, url }) => {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <div
          ...
          className="absolute inset-0 w-full h-full rounded-xl text-center bg-black opacity-80 p-3 text-slate-200 flex flex-col items-center justify-center"
        >
